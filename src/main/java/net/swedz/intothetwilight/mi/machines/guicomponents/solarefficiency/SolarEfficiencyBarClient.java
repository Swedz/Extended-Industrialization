package net.swedz.intothetwilight.mi.machines.guicomponents.solarefficiency;
...
public final class SolarEfficiencyBarClient implements GuiComponentClient
{
	...
	private final class Renderer implements ClientComponentRenderer
	{
		...
		private final ResourceLocation SOLAR_STATE = IntoTheTwilight.id("textures/gui/container/solar_state.png");
