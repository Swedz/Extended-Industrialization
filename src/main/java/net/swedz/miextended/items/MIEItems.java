...
public final class MIEItems
{
	...
	public static final MIEItemWrapper CANNED_FOOD = create().identifiable("canned_food", "Canned Food").withCreator(TinCanFoodItem::new).withProperties((p) -> p.food(new FoodProperties.Builder().nutrition(2).saturationMod(0.3f).fast().build())).withBasicModel().register();
