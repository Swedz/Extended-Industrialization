...
public final class SolarEfficiencyBarClient implements GuiComponentClient
{
	...
	private final class Renderer implements ClientComponentRenderer
	{
		...
		private final ResourceLocation SOLAR_STATE = MIExtended.id("textures/gui/container/solar_state.png");
		...
		public void renderTooltip(MachineScreen screen, Font font, GuiGraphics guiGraphics, int x, int y, int cursorX, int cursorY)
		{
			...
			{
				guiGraphics.renderTooltip(font, MIEText.SOLAR_EFFICIENCY.text(efficiency), cursorX, cursorY);
			}
		}
	}
}
