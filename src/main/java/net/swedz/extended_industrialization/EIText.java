...
public enum EIText implements TranslatableTextEnum
{
	...
	TESLA_CALIBRATOR_HELP_1("- Press %s + %s on a Tesla Tower to save its position in the calibrator."),
	TESLA_CALIBRATOR_HELP_2("- Use %s on a Tesla Receiver to link it to the selected tower."),
	...
	TESLA_CARRYON_CLEAR("Cleared selected transmitter."),
	TESLA_CARRYON_HELP_1("Receives energy from a linked transmitter within range and charges items while in your inventory."),
	TESLA_CARRYON_HELP_2("Tesla Calibration:"),
	TESLA_CARRYON_HELP_3("- Press %s on a Tesla Tower to link the receiver to it."),
	TESLA_CARRYON_HELP_4("- Clear using %s + %s on air."),
	TESLA_CARRYON_LINKED("Linked to %s"),
	TESLA_CARRYON_SELECTED("Selected transmitter for receiving."),
