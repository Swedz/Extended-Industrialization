...
public enum EIText
{
	...
	MACHINE_CONFIG_CARD_HELP_6("- (Optional) Hold in off-hand when placing"),
	MACHINE_CONFIG_CARD_HELP_7("  machines to automatically apply settings."),
	MACHINE_CONFIG_CARD_HELP_8("Clear using shift-right click on air."),
