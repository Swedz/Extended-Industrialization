...
public enum EIText implements MICompatibleTranslatableTextEnum
{
	...
	TESLA_COIL_HELP_1("Wirelessly transmits energy to linked receivers within range."),
	TESLA_COIL_HELP_2("Voltage of energy transmitted is set by the hull provided."),
