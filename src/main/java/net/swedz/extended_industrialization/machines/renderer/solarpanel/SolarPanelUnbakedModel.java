...
public final class SolarPanelUnbakedModel implements IUnbakedGeometry<SolarPanelUnbakedModel>
{
	...
	SolarPanelUnbakedModel(JsonObject obj)
	{
						   ...
						   ModelState modelState, ItemOverrides overrides, ResourceLocation modelLocation)
	{
		...
		return new SolarPanelBakedModel(baseCasing, defaultOverlays, tieredOverlays);
	}
